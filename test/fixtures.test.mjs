...
test("fixture generation drops in HOS without copying source README", () => {
    ...
    try {
        ...
        const prepared = prepareFixture({ scenario, sourcePath: config.source.path, runDir: root });
...
test("existing AGENTS.md fixture preserves host content before merge", () => {
